...
- Confidence: candidate
- Skip when: Bugbot flags an export, component, helper, or file as unused, and `gh pr diff <n>`, an explicit branch comparison, or PR context shows it is used by a later PR in the chain.
